...
export const faqItems: FaqItem[] = [
  {
    ...
    answer:
      '홈페이지 상단 [진료예약] > [인터넷 진료예약]에서 의료진·진료일·시간을 선택해 예약할 수 있습니다. 회원 로그인 또는 비회원 인증 후 이용 가능하며, 24시간 예약이 가능합니다. 예약이 어려우신 경우 예약센터(1588-5700)로 문의해 주세요.',
  },
  {
    id: 'faq-002',
    category: 'reservation',
  ...
  },
  {
    id: 'faq-003',
    category: 'reservation',
    question: '비회원도 인터넷 예약이 가능한가요?',
    answer:
      '네, 가능합니다. [비회원 로그인]에서 이름, 환자번호(진찰권번호), 휴대전화 인증 후 예약·조회·취소를 하실 수 있습니다. 최초 이용 시 진료회원 인증이 필요할 수 있습니다.',
  },
  {
    id: 'faq-004',
    category: 'reservation',
  ...
  },
  {
    ...
    answer:
      '타 병·의원에서 발급한 요양급여의뢰서(진료의뢰서)를 지참하시면 초진 접수가 가능합니다. 응급·외상 등 의뢰서 없이 내원이 필요한 경우 진료과 안내에 따라 접수해 주세요. 자세한 사항은 외래진료안내를 참고하시거나 예약센터로 문의해 주세요.',
  },
  {
    id: 'faq-006',
    category: 'outpatient',
    ...
    answer:
      '신분증, 진찰권(환자번호) 확인이 가능한 자료, 요양급여의뢰서(해당 시), 기존 검사 CD·의무기록 사본 등을 준비해 주세요. 재활치료·도수치료 예약이 있는 경우 운동복·수건을 지참하시면 편리합니다.',
  },
  {
    id: 'faq-007',
    category: 'outpatient',
  ...
  },
  {
    ...
    answer:
      '의무기록 사본은 환자 본인 또는 법정 대리인이 신청할 수 있습니다. 신분증·위임장(대리인 시)을 지참하시고, 창구 방문 또는 온라인 신청(증명서발급 사이트)을 이용해 주세요. 발급 소요 기간은 신청 건수에 따라 3~7일 정도 소요될 수 있습니다.',
  },
  {
    id: 'faq-012',
    category: 'etc',
